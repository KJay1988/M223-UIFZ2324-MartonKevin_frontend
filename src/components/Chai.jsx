...
import backgroundImage from "../assets/background_chai.PNG"; // ✅ Hintergrundbild importieren
...
const Chai = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                // ✅ Nur Helfer mit Einsatzort "Chai" anzeigen
                const filteredVolunteers = result.data.filter(volunteer => volunteer.einsatzort === "Chai");
    ...
    return (
        <div style={styles.container}>
            <h2 style={styles.heading}>Helfer im Ressort Chai</h2>
