...
import backgroundImage from "../assets/background_bar.PNG"; // ✅ Hintergrundbild importieren
...
const Bar = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                // ✅ Nur Helfer mit Einsatzort "Bar" anzeigen
                const filteredVolunteers = result.data.filter(volunteer => volunteer.einsatzort === "Bar");
    ...
    return (
        <div style={styles.container}>
            <h2 style={styles.heading}>Helfer im Ressort Bar</h2>
